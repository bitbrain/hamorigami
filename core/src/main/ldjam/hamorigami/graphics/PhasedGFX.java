...
public class PhasedGFX {
   ...
   private static Color colourOne = Color.WHITE;
   private static Color colourTwo = Color.valueOf("c7e0ff");
   ...
   public static void drawSphereLightning(Batch batch, Vector2 point, float thickness, int numberOfBolts, int radius, int circleSegments) {
      drawSphereLightning(batch, point, thickness, numberOfBolts, radius, circleSegments, colourOne, colourTwo);
   }

   public static void drawSphereLightning(Batch batch, Vector2 point, float thickness, int numberOfBolts, int radius, int circleSegments, Color colourA, Color colourB) {
   ...
   public static void drawChainLightningRandomBetweenPoints(Batch batch, Vector2 startPos, Vector2 endPointOne, Vector2 endPointTwo) {
   ...
   public static void drawChainLightningRandomBetweenPoints(Batch batch, Vector2 startPos, Vector2 endPointOne, Vector2 endPointTwo, float thickness, int numberOfBolts) {
      Vector2[] points = new Vector2[2];
      points[1] = startPos;
      points[0] = new Vector2(MathUtils.random(endPointOne.x, endPointTwo.x), MathUtils.random(endPointOne.y, endPointTwo.y));
      drawChainLightning(batch, points, thickness, numberOfBolts, colourOne, colourTwo);
   ...
   public static void drawChainLightningRandomBetweenPoints(Batch batch, Vector2 startPos, Vector2 endPointOne, Vector2 endPointTwo, float thickness, int numberOfBolts, Color colourA, Color colourB) {
      Vector2[] points = new Vector2[2];
      points[1] = startPos;
      points[0] = new Vector2(MathUtils.random(endPointOne.x, endPointTwo.x), MathUtils.random(endPointOne.y, endPointTwo.y));
   ...
   public static void drawChainLightning(Batch batch, Vector2[] points, Color colourA, Color colourB) {
      drawChainLightning(batch, points, thickness, numberOfBolts, colourA, colourB);
   }

   public static void drawChainLightning(Batch batch, Vector2[] points) {
      drawChainLightning(batch, points, thickness, numberOfBolts, colourOne, colourTwo);
   }

   public static void drawChainLightning(Batch batch, Vector2[] points, float thickness, int numberOfBolts) {
      drawChainLightning(batch, points, thickness, numberOfBolts, colourOne, colourTwo);
   }

   public static void drawChainLightning(Batch batch, Vector2[] points, float thickness, int numberOfBolts, Color colourA, Color colourB) {
   ...
   private static void drawLine(Batch batch, float x1, float y1, float x2, float y2, float thickness, Texture tex) {
   ...
   private static void drawP2PLightning(Batch batch, float x1, float y1, float x2, float y2, float displace, float detail, float thickness, int numberOfBolts, Color colourA, Color colourB) {
   ...
   private static void drawSingleP2PLightning(Batch batch, float x1, float y1, float x2, float y2, float displace, float detail, float thickness) {
      if (displace < detail) {
